...
class PrivateChatWithMom extends StatefulWidget {
  static const String routeName="privateMom";
  final ChatRoomModel chatRoom;
  const PrivateChatWithMom({Key? key, required this.chatRoom}) : super(key: key);
  @override
  State<PrivateChatWithMom> createState() => _PrivateChatWithMomState();
}

class _PrivateChatWithMomState extends State<PrivateChatWithMom> {
