        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              TxtField(hinttxt: model?.bio??"", controller: bio,cardcolor: Colours.primarygrey,hintcolor: Colours.primaryblue,stylecolor: Colors.black,),
        ...
        child:  Center(
          child: Padding(
            ...
            child: AppButton(txt: "Confirm", onclick: (){
              ...
              UserApis.updateProfile(userModel, onSuccess: () {
                setState(() {
