...
import 'package:downcare/Screens/DoctorDemo/DoctorAccount/DoctorEditProfile.dart';
...
class DoctorProfile extends StatefulWidget {
  ...
  @override
  State<DoctorProfile> createState() => _ProfileState();
}
class _ProfileState extends State<DoctorProfile> {
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  Text("Specialization", style: TextStyle(color: Colours.primaryblue, fontSize: 16.sp)),
                  ProfileCard(label: loginUserModel?.bio ?? "no governorate"),
                ],
              ),
            ),
          );
